CREATE DATABASE STUDENT_INFO_354

USE STUDENT_INFO_354
SELECT * FROM Student 
...
--9. Find All Students in which Email Contains ‘3@G’ & Only Six Characters
		SELECT * FROM STUDENT WHERE EMAIL LIKE '______' AND EMAIL LIKE '%3@G%'
.
...
--8885999922.
		UPDATE STUDENT SET NAME='FIROZ SHERASHIYA' WHERE EMAIL='FIROZ.ME@GMAIL.COM' AND CONTACTNO='8885999922'
...
--18. Change Column Name Email to EmailAddress.
		SP_RENAME 'STUDENT.EMAIL','STUDENT.EMAILADRESS'

--19. Write an SQL query to clone a new table Student_New from Student table with all data.
		SELECT * INTO STUDEN_NEW FROM STUDENT 
		
		SELECT * FROM STUDEN_NEW	
